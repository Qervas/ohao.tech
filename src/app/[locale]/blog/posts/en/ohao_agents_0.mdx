...
image: "/images/blogs/agents/0.png"
summary: "Day 1: Starting my journey to build a multi-agent system that works while I sleep"
tag: "Startup"
---
...
<Comment
  ...
  content={
    <>
      This is the first post in my startup building series. I'll be documenting my journey daily as I build this system, sharing both successes and failures along the way.
    </>
  }
/>
